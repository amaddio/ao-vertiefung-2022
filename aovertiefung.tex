...
\end{tabular}
  \begin{tablenotes}[para,flushleft]
        ...
        \tabfnt{\tiny a} Initial effect rating of (negative) experience due to the ambiguity in communication. \\
        \tabfnt{\tiny b} Latest effect rating after ambiguity in communication has been tried to be improved. \\ 
        \tabfnt{\tiny c}Functional improvement: The improvement strategy changes a negative impact of a en-/decoding experience into a neutral or positive effect on the outcome.
         }
    \end{tablenotes}
\end{table}
